...
# Protocolo ARP
  ...
  - O que é: ARP(Address resolution procol) é um protocolo responsável por descobrir o endereço de fábrica de um dispositivo
    ...
    - Como funciona: Quando um Dispositivo utilizando IP não sabe o MAC de um dispositivo da mesma rede ele:
      ...
      - 3° No lado de quem perguntou, o endereço MAC do disposotovo perguntado é adcionado a tabela arp
   ...
   - O que são Broadcast,unicast e ethernet:
      ...
      - 3° Ethernet: É um tipo e pacote rede LAN que inclui:
           - MAC de origem
           - MAC de destino
           - payload(conteúdo do pacote)
           - CRC(Check de Redundância Cíclica), é um mecanimo de detecçãod e error utilizado me pacotes em redes LAN.
